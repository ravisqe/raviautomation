...
public class NewCustomer  extends BasePage {
    ...
    public String createResidentialCustomer( String CustomerType,String category ,String Tittle, String firstName, String lastName, String phoneNumber, String Fax, String email, String billingEmail, String reminder, String addressOne, String addressTwo, String city, String state,String ZipCode1,String AddressCompany,String Address1,String Address2,String City,String State,String ZipCode,String Country ,String AccountName, String AuthenticationType,String AuthenticationNo,String DOB,String Refrence,String Contactno,String RefreeRelationship,String BankAccountName,String BankAccountType,String BankAccountNo,String BankRoute,String BankName,String a,String b,String Note) throws InterruptedException
    {
    	Assertions as=new Assertions();

        clickCustomerTab();
        if (category.equals("Business")|| category.equals("Commercial")||category.equals("Residential")) {
            enterAccountType(CustomerType,category);
        }
     //   enterCompanyDetails(a,b);   
    //  AccountType(CustomerType,category);
